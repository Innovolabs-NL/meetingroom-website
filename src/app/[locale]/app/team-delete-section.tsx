...
export function TeamDeleteSection({
  ...
  return (
    <>
      <section className="rounded-2xl border border-red-500/25 bg-red-500/5 px-6 pb-6 pt-8">
        <h2 className="text-lg font-semibold tracking-tight text-red-100">{t("deleteTeamTitle")}</h2>
